...
- All locales together. Every user-facing string lands in English, Arabic, Hindi, Indonesian, and Spanish together; the copy test enforces key parity. No em dashes anywhere. Write plain, concrete sentences; avoid machine-sounding filler.
