...
Launched 31 August 2026 at https://expatrate.pages.dev. Live coverage: 50 countries with verified market benchmarks (1,131 curated rows) and 2026 tax treatment (statutory brackets for 24 regimes), a purchasing-power floor for all 206 supported countries, English, Arabic, and Hindi locales with full RTL. The gate (typecheck, 160 unit tests, 60 Playwright end to end tests, build) runs in CI on every push.
